...
public class StreamingRsvpsDStream {
    ...
    public static void main(String[] args) throws InterruptedException{
        ...
        rsvpsWithGuestsStream
                .foreachRDD((JavaRDD<ConsumerRecord<String, String>> r) -> {
                    MongoSpark.save(
                     r.map(
        ...
        meetupStream.foreachRDD((JavaRDD<ConsumerRecord<String, String>> meetupRDD) -> {
            OffsetRange[] offsetRanges = ((HasOffsetRanges) meetupRDD.rdd())
                    .offsetRanges();
            // manually committing offsets in the topic
